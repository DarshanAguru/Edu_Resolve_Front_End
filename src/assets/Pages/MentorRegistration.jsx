...
const formFields = [
  ...
  { label: "Email", id: "email", placeholder: "Enter email", required: true, type: "email" },
  { label: "Age", id: "Age", placeholder: "Enter Age", required: true, type: "number"},
  {
    label: "Gender",
    id: "gender",
    type: "select",
...
const MentorRegistration = () => {
  ...
  return (
    <div className="xl:mx-auto">
      <p className="text-center mt-5 font-bold font-Montserrat text-3xl">Mentor Signup</p>
      <form onSubmit={handleSubmit} className="mx-10 my-2 xl:grid xl:grid-cols-2  gap-4">
        {formFields.map((field, index) =>
          field.type === "checkbox" ? (
            <FormCheckboxGroup key={index} {...field} onChange={handleChange} required={!isSubjectExpertiseValid} />
          ) : (
